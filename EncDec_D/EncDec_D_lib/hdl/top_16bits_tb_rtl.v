...
PWDATA 	<=	{{AMBA_WORD-11{1'b0}}, {11'b11001110110}}; // 10101010
...
PWDATA <= {{AMBA_WORD-2{1'b1}},{2'b01}};  //// 0000000000
...
repeat(5)@(posedge clk);
// Data 1 error
PWDATA <= {{AMBA_WORD-16{1'b0}},{16'b0001000000000000}}; // 11111__1100
...
#6;
$display("Test 1 Data_Out: 			%b",16'b1100111011011010==data_out);
$display("Test 1 Number_of_Errors: 	%b",2'b01==num_of_errors);


repeat(5)@(posedge clk);
// 0 error
PWDATA <= {{AMBA_WORD-16{1'b0}},{16'b0000000000000000}}; // 11111__1100
PADDR <= {{AMBA_ADDR_WIDTH-4{1'b0}},{4'b1100}}; // NOISE
PSEL <= 1'b1;
...
#6;
$display("Test 2 Data_Out: 			%b",16'b1100111011011010==data_out);
...
#6;
$display("Test 3 Data_Out: 			%b",16'b1100111011011010==data_out);
...
#6;
$display("Test 4 Data_Out: 			%b",16'b1100111011011010!=data_out);
...
#6;
$display("Test 5 Data_Out: 			%b",16'b1100111011011010!=data_out);
$display("Test 5 Number_of_Errors: 	%b",2'b10==num_of_errors);


repeat(5)@(posedge clk);
// Data 2 error
PWDATA <= {{AMBA_WORD-8{1'b0}},{8'b1100000}}; // 11111__1100
PADDR <= {{AMBA_ADDR_WIDTH-4{1'b0}},{4'b1100}}; // NOISE
PSEL <= 1'b1;
...
#6;
$display("Test 6 Data_Out: 			%b",16'b1100111011011010!=data_out);
