...
PWDATA 	<=	{{AMBA_WORD-8{1'b0}}, {8'b00000001}}; // 10101010
...
#6;
$display("%b",8'b00011011);
$display("%b",data_out);
$display("Test 1 Data_Out: 			%b",8'b00011011==data_out);
...
#6;
$display("Test 2 Data_Out: 			%b",8'b00011011==data_out);
...
#6;
$display("Test 3 Data_Out: 			%b",8'b00011011==data_out);
...
#6;
$display("Test 4 Data_Out: 			%b",8'b00011011!=data_out);
...
#6;
$display("Test 5 Data_Out: 			%b",8'b00011011!=data_out);
...
#6;
$display("Test 6 Data_Out: 			%b",8'b00011011!=data_out);
